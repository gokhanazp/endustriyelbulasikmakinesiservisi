...
export function DishwasherIcon({ className = "h-6 w-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="7" cy="4.75" r="0.5" fill="currentColor" />
      <line x1="14" y1="4.75" x2="17.5" y2="4.75" />
      {/* kapı camı / tambur */}
      <circle cx="12" cy="14" r="4.4" />
      <circle cx="12" cy="14" r="1.4" />
      {/* ayaklar */}
      <line x1="7" y1="21.5" x2="7" y2="22.5" />
      <line x1="17" y1="21.5" x2="17" y2="22.5" />
    </svg>
  );
}

export function WrenchIcon({ className = "h-6 w-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function DropletIcon({ className = "h-6 w-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
